  ...
  return (
    <footer className="py-[105px] px-32 footer">
      <div className="container flex justify-between">
        <div className="left">
          <Logo width={109} height={76} />
          <h5 className="mb-[84px] mt-2 text-sm leading-7 gray">
            © 2024 Company
          </h5>
        ...
        <div className="right">
          <h1 className="text-xl stretch w-[130%] font-medium capitalize">
            Subscribe To Your Newsletter
          </h1>
          <p className="gray mb-[25px]">
            If the fruit is reborn, you will be the first to know.
          </p>
          <div className="flex gap-[25px]">
            ...
            {/*  Респект за передачу сайзов, дизреспект за вписанные стили*/}
            <Button
              size="xl"
