  ...
  const handleLogin = async (e: any) => {
    ...
    try {
      const action = await dispatch(
        login({ email_address: email, password: password })
      );
  ...
  return (
    <div className="signup ">
      <div className="signup__form p-8">
        <div>
          ...
          <p>
            ...
            <span className="signup__login">create a new one.</span>
          </p>
        </div>
        <form action="">
          <div className="flex flex-col flex-wrap gap-y-5 mt-8">
            <div>
              ...
              <div className="flex justify-center items-center rounded-[15px] border border-white">
                <Input
                  name="email"
                  value={email}
      ...
      <Image
        width={720}
        height={716}
        src={new URL("@/shared/assets/img/loginForm.png", import.meta.url).href}
        alt=""
      />
    </div>
  );
